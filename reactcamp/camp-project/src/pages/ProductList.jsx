...
export default function Ürünler() {
    ...
    const dispatch = useDispatch() // bir aksiyon/fonx çağırmak icin kullanılan ifadedir

    // lifecycle hook tekniği 
    const [products, setProducts] = useState([]) // soldaki yapı neydi: destructor işlemi sağda ise fonx içi bir dizi almış demekki useState bize bir nesne döndürüyor, biri data(products) bir de fonx(setProducts) döndürüyor   
